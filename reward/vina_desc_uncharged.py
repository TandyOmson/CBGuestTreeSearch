        ...
        def VinaScore(mol):
            ...
            with tempfile.TemporaryDirectory() as tmpdir:
                ...
                try:
                    ...
                    autocorr_4m, rdf_10p, mor22v, n_oxygen = get_descs_uncharged(docked_guest)

                    final_en = final_en + 0.34837636*autocorr_4m - 1.64981047*rdf_10p - 7.30912975*mor22v + 1.17509933*n_oxygen + 0.03206162
