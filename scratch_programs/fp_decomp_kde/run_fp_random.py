...
decomper = FingerprintDecomposition(
    Pipeline([('decomp', PCA(n_components=2)), ('scaler', MinMaxScaler((-1,1)))]),
    "PCA",
    rdFingerprintGenerator.GetMorganGenerator(radius=2).GetFingerprint,
    "morgan",
    )
