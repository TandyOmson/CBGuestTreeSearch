...
def main():
    ...
    model.add(
        GRU(
            conf["units_GRU_1"],
            activation="tanh",
            dropout=conf["dropout_rate_GRU_1"],
            recurrent_dropout=conf["rec_dropout_rate_GRU_1"],
    ...
    model.add(
        GRU(
            conf["units_GRU_2"],
            activation="tanh",
            dropout=conf["dropout_rate_GRU_2"],
            recurrent_dropout=conf["rec_dropout_rate_GRU_2"],
            return_sequences=True,
        )
    )
    model.add(
