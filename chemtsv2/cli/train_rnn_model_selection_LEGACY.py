...
def build_model_factory(token_list, X_len, conf):
    def build_model(hp):
        ...
        model.add(
            GRU(
                ...
                input_shape=(X_len, len(token_list)),
                activation="tanh",
        ...
        model.build(input_shape=(X_len, len(token_list)))
        model.summary()
...
def main():
    ...
    tuner = keras_tuner.RandomSearch(
        hypermodel = build_model_factory(token_list, X.shape[1], conf),
        objective = 'val_loss',
